...
โดยมี{\it {\TestPath} (ฉ)} ที่เลือก ดัง\tablename\ \tabpageref{tab:testPath}
...
แนวทางการดำเนินงานในขั้นตอนนี้จะรับ {\it ชุดกรณีทดสอบ (ญ)} เข้าทดสอบร่วมกับ{\sourcecode}ที่ผ่านการแทรกคำสั่ง (จ) จากฐานข้อมูล (A) 
