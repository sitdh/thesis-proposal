...
ซึ่งรูปแบบความสำพันธ์ของ{\cfg}นั้น McCabe \cite{Watson1996} 
...
แทนด้วยกราฟ \code{G} จึงสามารถเขียนความสัมพันธ์ในรูปของทูเปิ้ล 8 รายการ \code{G = (V, E, tail, head, \ell_V, \ell_E, \sigma, \delta)}
