...
\figpageref{fig:pseudocodeGrading} ให้เป็น{\sourcecode}ภาษาจาวา (Java) โดยแยกออกเป็น 2 \class\ ได้แก่ \code{SimpleBonusScore} 
และ \code{SimpleGrading} ดัง \figpageref{fig:javaBonusScore} และ\figpageref{fig:javaGrading}ตามลำดับ
...
เนื่องจากไม่สามารถหาค่าที่สอดคล้อง กับ\PredicateNode\ 12 และ 14 นั่นคือ \code{student\_score \geq 80} และ 
\code{student\_score = 0} ได้ในทุก ๆ กรณี
