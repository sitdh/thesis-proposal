...
\newcommand{\graphCreation}{วิเคราะห์{\sourcecode}}
\newcommand{\graphCreationEN}{Source code analysis}
...
\newcommand{\callingMethod}{เมธอดเรียกใช้}
\newcommand{\callingMethodEN}{Calling method}

\newcommand{\calledMethod}{เมธอดที่ถูกเรียกใช้}
\newcommand{\calledMethodEN}{Called method}

\newcommand{\statement}{แถวคำสั่ง}
\newcommand{\statementEN}{Statement}

\newcommand{\callingStatement}{แถวคำสั่งเรียกใช้}
\newcommand{\callingStatementEN}{Calling statement}
