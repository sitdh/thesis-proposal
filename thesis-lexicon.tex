...
\newcommand{\MethodSignature}{Method signature}
...
\newcommand{\ProgramGraph}{กราฟของโปรแกรม}
...
\newcommand{\sinknodeEN}{Sink path}

\newcommand{\Cyclometric}{Cyclomatic Complexity}
\newcommand{\CyclometricEN}{Cyclomatic Complexity}
