...
\begin{enumerate}
    ...
    \item สร้างกรณีทดสอบที่ครอบคลุมกิ่งทั้งหมดของ{\scg} (Branch coverage) ที่สร้างขึ้นจาก{\StaticInformation}ของ{\SUT} \label{enu:lim:branchcoverage}
    ...
    \item รองรับการดำเนินงานแบบวงวน (Loop) 1 รอบ บนเส้นทางทดสอบ\label{enu:lim:loop}
